...
public class SignInResponse extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getResolveAccountResponse", mo8007id = 3)
    private final ResolveAccountResponse zzadu;
    @SafeParcelable.VersionField(mo8013id = 1)
    private final int zzal;
    @SafeParcelable.Field(getter = "getConnectionResult", mo8007id = 2)
    ...
    SignInResponse(@SafeParcelable.Param(mo8010id = 1) int i, @SafeParcelable.Param(mo8010id = 2) ConnectionResult connectionResult, @SafeParcelable.Param(mo8010id = 3) ResolveAccountResponse resolveAccountResponse) {
        this.zzal = i;
