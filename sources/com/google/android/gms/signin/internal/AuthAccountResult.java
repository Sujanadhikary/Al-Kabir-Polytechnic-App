...
public class AuthAccountResult extends AbstractSafeParcelable implements Result {
    ...
    @SafeParcelable.Field(getter = "getConnectionResultCode", mo8007id = 2)
    private int zzadn;
    @SafeParcelable.Field(getter = "getRawAuthResolutionIntent", mo8007id = 3)
    ...
    AuthAccountResult(@SafeParcelable.Param(mo8010id = 1) int i, @SafeParcelable.Param(mo8010id = 2) int i2, @SafeParcelable.Param(mo8010id = 3) Intent intent) {
        this.zzal = i;
        this.zzadn = i2;
        this.zzado = intent;
    }
