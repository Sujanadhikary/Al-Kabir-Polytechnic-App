...
public class SignInRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getResolveAccountRequest", mo8007id = 2)
    private final ResolveAccountRequest zzadt;
    @SafeParcelable.VersionField(mo8013id = 1)
    private final int zzal;

    @SafeParcelable.Constructor
    SignInRequest(@SafeParcelable.Param(mo8010id = 1) int i, @SafeParcelable.Param(mo8010id = 2) ResolveAccountRequest resolveAccountRequest) {
        this.zzal = i;
