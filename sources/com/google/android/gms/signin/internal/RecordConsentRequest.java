...
public class RecordConsentRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getScopesToConsent", mo8007id = 3)
    ...
    @SafeParcelable.Field(getter = "getServerClientId", mo8007id = 4)
    private final String zzw;

    @SafeParcelable.Constructor
    RecordConsentRequest(@SafeParcelable.Param(mo8010id = 1) int i, @SafeParcelable.Param(mo8010id = 2) Account account, @SafeParcelable.Param(mo8010id = 3) Scope[] scopeArr, @SafeParcelable.Param(mo8010id = 4) String str) {
        this.zzal = i;
        this.zzs = account;
        this.zzadr = scopeArr;
        this.zzw = str;
