...
public final class zzba extends zzbfc<zzba> {
        ...
        while (true) {
            ...
            switch (zzabk) {
                ...
                case 346:
                    ...
                    zzbfi[] zzbfiArr = new zzbb[(zzb + length)];
                    if (length != 0) {
                        System.arraycopy(this.zzeu, 0, zzbfiArr, 0, length);
                    }
                    while (length < zzbfiArr.length - 1) {
                        zzbfiArr[length] = new zzbb();
                        zzbez.zza(zzbfiArr[length]);
                        zzbez.zzabk();
                        length++;
                    }
                    zzbfiArr[length] = new zzbb();
    ...
    public final void zza(zzbfa zzbfa) throws IOException {
        ...
        zzba.super.zza(zzbfa);
    }

    /* access modifiers changed from: protected */
    public final int zzr() {
        int zzr = zzba.super.zzr();
        if (this.zzdc != null) {
