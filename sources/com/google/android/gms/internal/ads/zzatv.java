...
public final class zzatv extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getAfmaSignalsAsBytes", mo8007id = 2, type = "byte[]")
    private zzba zzdhe = null;
    private byte[] zzdhf;

    @SafeParcelable.Constructor
    zzatv(@SafeParcelable.Param(mo8010id = 1) int i, @SafeParcelable.Param(mo8010id = 2) byte[] bArr) {
        this.versionCode = i;
        this.zzdhf = bArr;
        zzwf();
    }
    ...
    public final zzba zzwe() {
        if (!(this.zzdhe != null)) {
            try {
                this.zzdhe = zzbfi.zza(new zzba(), this.zzdhf);
                this.zzdhf = null;
            } catch (zzbfh e) {
