...
interface zzgl {
    ...
    void zza(int i, zzbu zzbu) throws IOException;

    <K, V> void zza(int i, zzea<K, V> zzea, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzex zzex) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzex zzex) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzex zzex) throws IOException;

    void zzb(int i, List<zzbu> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzex zzex) throws IOException;
