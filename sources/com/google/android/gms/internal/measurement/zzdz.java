...
public final class zzdz extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "Integer.MIN_VALUE", mo8007id = 11)
    ...
    @SafeParcelable.Field(defaultValue = "true", mo8007id = 9)
    public final boolean zzadw;
    @SafeParcelable.Field(mo8007id = 13)
    public final long zzadx;
    @SafeParcelable.Field(defaultValue = "true", mo8007id = 16)
    public final boolean zzady;
    @SafeParcelable.Field(defaultValue = "true", mo8007id = 17)
    ...
    @SafeParcelable.Field(mo8007id = 14)
    public final long zzaem;
    @SafeParcelable.Field(mo8007id = 15)
    public final int zzaen;
    @SafeParcelable.Field(mo8007id = 18)
    ...
    zzdz(@SafeParcelable.Param(mo8010id = 2) String str, @SafeParcelable.Param(mo8010id = 3) String str2, @SafeParcelable.Param(mo8010id = 4) String str3, @SafeParcelable.Param(mo8010id = 5) String str4, @SafeParcelable.Param(mo8010id = 6) long j, @SafeParcelable.Param(mo8010id = 7) long j2, @SafeParcelable.Param(mo8010id = 8) String str5, @SafeParcelable.Param(mo8010id = 9) boolean z, @SafeParcelable.Param(mo8010id = 10) boolean z2, @SafeParcelable.Param(mo8010id = 11) long j3, @SafeParcelable.Param(mo8010id = 12) String str6, @SafeParcelable.Param(mo8010id = 13) long j4, @SafeParcelable.Param(mo8010id = 14) long j5, @SafeParcelable.Param(mo8010id = 15) int i, @SafeParcelable.Param(mo8010id = 16) boolean z3, @SafeParcelable.Param(mo8010id = 17) boolean z4, @SafeParcelable.Param(mo8010id = 18) boolean z5) {
        this.packageName = str;
        this.zzadm = str2;
        this.zzth = str3;
        this.zzads = j3;
