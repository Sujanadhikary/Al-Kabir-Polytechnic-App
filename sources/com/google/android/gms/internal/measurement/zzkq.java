...
public final class zzkq extends zzaby<zzkq> {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!zzacc.equals((Object[]) this.zzati, (Object[]) zzkq.zzati)) {
            return false;
        }
        if (!zzacc.equals((Object[]) this.zzatj, (Object[]) zzkq.zzatj)) {
            return false;
        }
        if (this.zzatk == null) {
            if (zzkq.zzatk != null) {
    ...
    public final int zza() {
        ...
        if (this.zzati != null && this.zzati.length > 0) {
            int i = zza;
            for (zzkn zzkn : this.zzati) {
                if (zzkn != null) {
                    i += zzabw.zzb(2, (zzace) zzkn);
                }
            }
            zza = i;
        }
        if (this.zzatj != null && this.zzatj.length > 0) {
            int i2 = zza;
            for (zzks zzks : this.zzatj) {
                if (zzks != null) {
                    i2 += zzabw.zzb(3, (zzace) zzks);
                }
            }
            zza = i2;
        }
