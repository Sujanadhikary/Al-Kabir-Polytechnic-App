...
public final class zzfe extends zzhh {
    ...
    private final void zza(StringBuilder sb, int i, zzkf zzkf) {
        if (zzkf != null) {
            ...
            zza(sb, i + 1, "number_filter", zzkf.zzarw);
            zza(sb, i);
            sb.append("}\n");
        }
    }
        ...
        if (zzkp.zzatf != null) {
            for (zzkq zzkq : zzkp.zzatf) {
                if (!(zzkq == null || zzkq == null)) {
                    ...
                    if (zzkq.zzauj != null) {
                        zza(sb, 1, "retry_counter", (Object) zzkq.zzauj);
                    }
    ...
    public final String zzbj(String str) {
        ...
        return zzil() ? zza(str, AppMeasurement.Event.zzacy, AppMeasurement.Event.zzacx, zzaij) : str;
    }
    ...
    public final String zzbk(String str) {
        ...
        return zzil() ? zza(str, AppMeasurement.Param.zzada, AppMeasurement.Param.zzacz, zzaik) : str;
    }
