...
public final class zzkk extends zzaby<zzkk> {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!zzacc.equals((Object[]) this.zzasr, (Object[]) zzkk.zzasr)) {
            return false;
        }
        if (!zzacc.equals((Object[]) this.zzass, (Object[]) zzkk.zzass)) {
            return false;
        }
        if (!zzacc.equals((Object[]) this.zzast, (Object[]) zzkk.zzast)) {
            return false;
        }
    ...
    public final int hashCode() {
        int i = 0;
        int hashCode = ((((((((this.zzasq == null ? 0 : this.zzasq.hashCode()) + (((this.zzadm == null ? 0 : this.zzadm.hashCode()) + (((this.zzasp == null ? 0 : this.zzasp.hashCode()) + ((getClass().getName().hashCode() + 527) * 31)) * 31)) * 31)) * 31) + zzacc.hashCode((Object[]) this.zzasr)) * 31) + zzacc.hashCode((Object[]) this.zzass)) * 31) + zzacc.hashCode((Object[]) this.zzast)) * 31;
