...
final class zzp implements Runnable {
    ...
    public final void run() {
        try {
            ...
            then.addOnFailureListener(TaskExecutors.zzagd, (OnFailureListener) this.zzafz);
            then.addOnCanceledListener(TaskExecutors.zzagd, (OnCanceledListener) this.zzafz);
