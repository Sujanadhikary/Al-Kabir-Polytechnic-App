...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", mo8007id = 2)
    private final int zzam;
    @SafeParcelable.Field(getter = "getResolution", mo8007id = 3)
    private final PendingIntent zzan;
    @SafeParcelable.Field(getter = "getErrorMessage", mo8007id = 4)
    ...
    ConnectionResult(@SafeParcelable.Param(mo8010id = 1) int i, @SafeParcelable.Param(mo8010id = 2) int i2, @SafeParcelable.Param(mo8010id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(mo8010id = 4) String str) {
        this.zzal = i;
        this.zzam = i2;
