...
public class AuthAccountRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(mo8007id = 6, type = "android.accounts.Account")
    private Account zzs;

    @SafeParcelable.Constructor
    AuthAccountRequest(@SafeParcelable.Param(mo8010id = 1) int i, @SafeParcelable.Param(mo8010id = 2) IBinder iBinder, @SafeParcelable.Param(mo8010id = 3) Scope[] scopeArr, @SafeParcelable.Param(mo8010id = 4) Integer num, @SafeParcelable.Param(mo8010id = 5) Integer num2, @SafeParcelable.Param(mo8010id = 6) Account account) {
        this.zzal = i;
        this.zzqv = iBinder;
        this.zzqw = scopeArr;
        this.zzqx = num;
