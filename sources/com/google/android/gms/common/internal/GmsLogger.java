...
public final class GmsLogger {
    ...
    /* renamed from: d */
    public final void mo7916d(String str, String str2) {
        if (canLog(3)) {
            Log.d(str, zzl(str2));
        }
    }
    ...
    /* renamed from: d */
    public final void mo7917d(String str, String str2, Throwable th) {
        if (canLog(3)) {
    ...
    /* renamed from: e */
    public final void mo7919e(String str, String str2) {
        if (canLog(6)) {
            Log.e(str, zzl(str2));
        }
    }
    ...
    /* renamed from: e */
    public final void mo7920e(String str, String str2, Throwable th) {
        if (canLog(6)) {
    ...
    /* renamed from: i */
    public final void mo7923i(String str, String str2) {
        if (canLog(4)) {
            Log.i(str, zzl(str2));
        }
    }
    ...
    /* renamed from: i */
    public final void mo7924i(String str, String str2, Throwable th) {
        if (canLog(4)) {
    ...
    /* renamed from: v */
    public final void mo7929v(String str, String str2) {
        if (canLog(2)) {
            Log.v(str, zzl(str2));
        }
    }
    ...
    /* renamed from: v */
    public final void mo7930v(String str, String str2, Throwable th) {
        if (canLog(2)) {
    ...
    /* renamed from: w */
    public final void mo7932w(String str, String str2) {
        if (canLog(5)) {
            Log.w(str, zzl(str2));
        }
    }
    ...
    /* renamed from: w */
    public final void mo7933w(String str, String str2, Throwable th) {
        if (canLog(5)) {
