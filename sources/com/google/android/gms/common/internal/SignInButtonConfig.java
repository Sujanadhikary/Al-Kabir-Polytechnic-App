...
public class SignInButtonConfig extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getScopes", mo8007id = 4)
    @Deprecated
    private final Scope[] zzqw;
    @SafeParcelable.Field(getter = "getButtonSize", mo8007id = 2)
    private final int zzux;
    @SafeParcelable.Field(getter = "getColorScheme", mo8007id = 3)
    private final int zzuy;

    @SafeParcelable.Constructor
    SignInButtonConfig(@SafeParcelable.Param(mo8010id = 1) int i, @SafeParcelable.Param(mo8010id = 2) int i2, @SafeParcelable.Param(mo8010id = 3) int i3, @SafeParcelable.Param(mo8010id = 4) Scope[] scopeArr) {
        this.zzal = i;
        this.zzux = i2;
        this.zzuy = i3;
        this.zzqw = scopeArr;
