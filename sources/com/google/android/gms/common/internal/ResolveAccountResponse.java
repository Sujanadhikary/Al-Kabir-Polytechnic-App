...
public class ResolveAccountResponse extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getConnectionResult", mo8007id = 3)
    private ConnectionResult zzeu;
    @SafeParcelable.Field(getter = "getSaveDefaultAccount", mo8007id = 4)
    private boolean zzhs;
    @SafeParcelable.Field(mo8007id = 2)
    private IBinder zzqv;
    @SafeParcelable.Field(getter = "isFromCrossClientAuth", mo8007id = 5)
    ...
    ResolveAccountResponse(@SafeParcelable.Param(mo8010id = 1) int i, @SafeParcelable.Param(mo8010id = 2) IBinder iBinder, @SafeParcelable.Param(mo8010id = 3) ConnectionResult connectionResult, @SafeParcelable.Param(mo8010id = 4) boolean z, @SafeParcelable.Param(mo8010id = 5) boolean z2) {
        this.zzal = i;
        this.zzqv = iBinder;
