...
public class ResolveAccountRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getAccount", mo8007id = 2)
    private final Account zzs;
    @SafeParcelable.Field(getter = "getSessionId", mo8007id = 3)
    private final int zzut;
    @SafeParcelable.Field(getter = "getSignInAccountHint", mo8007id = 4)
    private final GoogleSignInAccount zzuu;

    @SafeParcelable.Constructor
    ResolveAccountRequest(@SafeParcelable.Param(mo8010id = 1) int i, @SafeParcelable.Param(mo8010id = 2) Account account, @SafeParcelable.Param(mo8010id = 3) int i2, @SafeParcelable.Param(mo8010id = 4) GoogleSignInAccount googleSignInAccount) {
        this.zzal = i;
        this.zzs = account;
        this.zzut = i2;
