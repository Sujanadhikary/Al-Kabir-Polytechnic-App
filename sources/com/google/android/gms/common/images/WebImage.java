...
public final class WebImage extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getWidth", mo8007id = 3)
    private final int zzps;
    @SafeParcelable.Field(getter = "getHeight", mo8007id = 4)
    private final int zzpt;
    @SafeParcelable.Field(getter = "getUrl", mo8007id = 2)
    private final Uri zzpu;

    @SafeParcelable.Constructor
    WebImage(@SafeParcelable.Param(mo8010id = 1) int i, @SafeParcelable.Param(mo8010id = 2) Uri uri, @SafeParcelable.Param(mo8010id = 3) int i2, @SafeParcelable.Param(mo8010id = 4) int i3) {
        this.zzal = i;
        this.zzpu = uri;
        this.zzps = i2;
        this.zzpt = i3;
