...
public class Feature extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getName", mo8007id = 1)
    private final String name;
    @SafeParcelable.Field(getter = "getOldVersion", mo8007id = 2)
    @Deprecated
    private final int zzaq;
    @SafeParcelable.Field(defaultValue = "-1", getter = "getVersion", mo8007id = 3)
    private final long zzar;

    @SafeParcelable.Constructor
    public Feature(@SafeParcelable.Param(mo8010id = 1) String str, @SafeParcelable.Param(mo8010id = 2) int i, @SafeParcelable.Param(mo8010id = 3) long j) {
        this.name = str;
        this.zzaq = i;
        this.zzar = j;
    }
