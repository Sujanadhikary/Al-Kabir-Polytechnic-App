...
public class FieldMappingDictionary extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getSerializedDictionary", mo8007id = 2)
    private final ArrayList<Entry> zzxl;
    @SafeParcelable.Field(getter = "getRootClassName", mo8007id = 3)
    ...
    public static class Entry extends AbstractSafeParcelable {
        ...
        Entry(@SafeParcelable.Param(mo8010id = 1) int i, @SafeParcelable.Param(mo8010id = 2) String str, @SafeParcelable.Param(mo8010id = 3) ArrayList<FieldMapPair> arrayList) {
            this.versionCode = i;
            this.className = str;
            this.zzxn = arrayList;
        }
        ...
        Entry(String str, Map<String, FastJsonResponse.Field<?, ?>> map) {
            ...
            if (map == null) {
                ...
                for (String next : map.keySet()) {
                    arrayList2.add(new FieldMapPair(next, map.get(next)));
                }
    ...
    public static class FieldMapPair extends AbstractSafeParcelable {
        ...
        @SafeParcelable.Constructor
        FieldMapPair(@SafeParcelable.Param(mo8010id = 1) int i, @SafeParcelable.Param(mo8010id = 2) String str, @SafeParcelable.Param(mo8010id = 3) FastJsonResponse.Field<?, ?> field) {
            this.versionCode = i;
            this.zzxo = str;
            this.zzxp = field;
        }
    ...
    @SafeParcelable.Constructor
    FieldMappingDictionary(@SafeParcelable.Param(mo8010id = 1) int i, @SafeParcelable.Param(mo8010id = 2) ArrayList<Entry> arrayList, @SafeParcelable.Param(mo8010id = 3) String str) {
        this.zzal = i;
        this.zzxl = null;
