...
/* renamed from: com.my.alkabirin.SbtewebpageActivity */
public class SbtewebpageActivity extends AppCompatActivity {
    ...
    public String f39b = "";
    /* access modifiers changed from: private */
    public Intent backhoga2 = new Intent();
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C0409R.layout.sbtewebpage);
        initialize(bundle);
        initializeLogic();
    }
    ...
    private void initialize(Bundle bundle) {
        ...
        this.button1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                SbtewebpageActivity.this.backhoga2.setClass(SbtewebpageActivity.this.getApplicationContext(), WebpagemainActivity.class);
                SbtewebpageActivity.this.startActivity(SbtewebpageActivity.this.backhoga2);
            }
        });
        this.imageview1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                SbtewebpageActivity.this.webview1.goBack();
            }
        });
        this.imageview2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                SbtewebpageActivity.this.webview1.goForward();
            }
        });
        this.imageview3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                SbtewebpageActivity.this.webview1.stopLoading();
            }
        });
        this.imageview4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                SbtewebpageActivity.this.webview1.zoomIn();
            }
        });
        this.imageview5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                SbtewebpageActivity.this.webview1.zoomOut();
            }
        });
        this.webview1.setWebViewClient(new WebViewClient() {
            public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
                SbtewebpageActivity.this.f38a = SbtewebpageActivity.this.webview1.getUrl();
                SbtewebpageActivity.this.f40c = str;
                super.onPageStarted(webView, str, bitmap);
            }

            public void onPageFinished(WebView webView, String str) {
                SbtewebpageActivity.this.f39b = SbtewebpageActivity.this.webview1.getUrl();
                if (SbtewebpageActivity.this.f38a.equals(SbtewebpageActivity.this.f39b) && !SbtewebpageActivity.this.f40c.equals(SbtewebpageActivity.this.f39b)) {
                    SbtewebpageActivity.this.download.setAction("android.intent.action.VIEW");
                    SbtewebpageActivity.this.download.setData(Uri.parse(SbtewebpageActivity.this.f40c));
                    SbtewebpageActivity.this.startActivity(SbtewebpageActivity.this.download);
                }
    ...
    private void initializeLogic() {
        ...
        this.webview1.loadUrl("http://sbtejharkhand.nic.in");
    }
