...
/* renamed from: com.my.alkabirin.SyllabusActivity */
public class SyllabusActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C0409R.layout.syllabus);
        initialize(bundle);
        initializeLogic();
    }
    ...
    private void initialize(Bundle bundle) {
        ...
        this.linear10 = (LinearLayout) findViewById(C0409R.C0411id.linear10);
        ...
        this.button1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                SyllabusActivity.this.download.setClass(SyllabusActivity.this.getApplicationContext(), NeepageActivity.class);
                SyllabusActivity.this.startActivity(SyllabusActivity.this.download);
            }
        });
        this.imageview1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                SyllabusActivity.this.webview1.goBack();
            }
        });
        this.imageview2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                SyllabusActivity.this.webview1.goForward();
            }
        });
        this.imageview3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                SyllabusActivity.this.webview1.stopLoading();
            }
        });
        this.imageview4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                SyllabusActivity.this.webview1.zoomIn();
            }
        });
        this.imageview5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                SyllabusActivity.this.webview1.zoomOut();
            }
        });
        this.webview1.setWebViewClient(new WebViewClient() {
            public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
                SyllabusActivity.this.f41a = SyllabusActivity.this.webview1.getUrl();
                SyllabusActivity.this.f43c = str;
                super.onPageStarted(webView, str, bitmap);
            }

            public void onPageFinished(WebView webView, String str) {
                SyllabusActivity.this.f42b = SyllabusActivity.this.webview1.getUrl();
                if (SyllabusActivity.this.f41a.equals(SyllabusActivity.this.f42b) && !SyllabusActivity.this.f43c.equals(SyllabusActivity.this.f42b)) {
                    SyllabusActivity.this.download.setAction("android.intent.action.VIEW");
                    SyllabusActivity.this.download.setData(Uri.parse(SyllabusActivity.this.f43c));
                    SyllabusActivity.this.startActivity(SyllabusActivity.this.download);
                }
    ...
    private void initializeLogic() {
        ...
        this.webview1.loadUrl("https://alkabirpolytechnic2019.blogspot.com");
    }
