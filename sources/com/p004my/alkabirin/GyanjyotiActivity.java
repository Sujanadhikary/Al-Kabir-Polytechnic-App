...
/* renamed from: com.my.alkabirin.GyanjyotiActivity */
public class GyanjyotiActivity extends AppCompatActivity {
    ...
    public String f35b = "";
    /* access modifiers changed from: private */
    public Intent backhoga3 = new Intent();
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C0409R.layout.gyanjyoti);
        initialize(bundle);
        initializeLogic();
    }
    ...
    private void initialize(Bundle bundle) {
        ...
        this.button1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                GyanjyotiActivity.this.backhoga3.setClass(GyanjyotiActivity.this.getApplicationContext(), WebpagemainActivity.class);
                GyanjyotiActivity.this.startActivity(GyanjyotiActivity.this.backhoga3);
            }
        });
        this.imageview1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                GyanjyotiActivity.this.webview1.goBack();
            }
        });
        this.imageview2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                GyanjyotiActivity.this.webview1.goForward();
            }
        });
        this.imageview3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                GyanjyotiActivity.this.webview1.stopLoading();
            }
        });
        this.imageview4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                GyanjyotiActivity.this.webview1.zoomIn();
            }
        });
        this.imageview5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                GyanjyotiActivity.this.webview1.zoomOut();
            }
        });
        this.webview1.setWebViewClient(new WebViewClient() {
            public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
                GyanjyotiActivity.this.f34a = GyanjyotiActivity.this.webview1.getUrl();
                GyanjyotiActivity.this.f36c = str;
                super.onPageStarted(webView, str, bitmap);
            }

            public void onPageFinished(WebView webView, String str) {
                GyanjyotiActivity.this.f35b = GyanjyotiActivity.this.webview1.getUrl();
                if (GyanjyotiActivity.this.f34a.equals(GyanjyotiActivity.this.f35b) && !GyanjyotiActivity.this.f36c.equals(GyanjyotiActivity.this.f35b)) {
                    GyanjyotiActivity.this.download.setAction("android.intent.action.VIEW");
                    GyanjyotiActivity.this.download.setData(Uri.parse(GyanjyotiActivity.this.f36c));
                    GyanjyotiActivity.this.startActivity(GyanjyotiActivity.this.download);
                }
    ...
    private void initializeLogic() {
        ...
        this.webview1.loadUrl("http://164.100.150.10/gyanjyoti/");
    }
