...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0308R.styleable.ActionBar);
        this.mBackground = a.getDrawable(C0308R.styleable.ActionBar_background);
        this.mStackedBackground = a.getDrawable(C0308R.styleable.ActionBar_backgroundStacked);
        this.mHeight = a.getDimensionPixelSize(C0308R.styleable.ActionBar_height, -1);
        if (getId() == C0308R.C0310id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = a.getDrawable(C0308R.styleable.ActionBar_backgroundSplit);
        }
        a.recycle();
        if (this.mIsSplit) {
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0308R.C0310id.action_bar);
        this.mContextView = findViewById(C0308R.C0310id.action_context_bar);
    }
