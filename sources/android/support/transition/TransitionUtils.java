...
class TransitionUtils {
    ...
    static View copyViewImage(ViewGroup sceneRoot, View view, View parent) {
        ...
        copy.measure(View.MeasureSpec.makeMeasureSpec(right - left, CrashUtils.ErrorDialogData.SUPPRESSED), View.MeasureSpec.makeMeasureSpec(bottom - top, CrashUtils.ErrorDialogData.SUPPRESSED));
