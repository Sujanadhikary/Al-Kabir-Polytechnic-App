...
class PathInterpolatorApi14 implements Interpolator {
    ...
    public float getInterpolation(float t) {
        ...
        float xRange = this.f12mX[endIndex] - this.f12mX[startIndex];
        if (xRange == 0.0f) {
            return this.f13mY[startIndex];
        }
        float startY = this.f13mY[startIndex];
        return ((this.f13mY[endIndex] - startY) * ((t - this.f12mX[startIndex]) / xRange)) + startY;
    }
