...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        public RemoteViews applyStandardTemplate(boolean showSmallIcon, int resId, boolean fitIn1U) {
            ...
            if (Build.VERSION.SDK_INT >= 16 && Build.VERSION.SDK_INT < 21) {
                if (minPriority) {
                    contentView.setInt(C0004R.C0006id.notification_background, "setBackgroundResource", C0004R.C0005drawable.notification_bg_low);
                    contentView.setInt(C0004R.C0006id.icon, "setBackgroundResource", C0004R.C0005drawable.notification_template_icon_low_bg);
                } else {
                    contentView.setInt(C0004R.C0006id.notification_background, "setBackgroundResource", C0004R.C0005drawable.notification_bg);
                    contentView.setInt(C0004R.C0006id.icon, "setBackgroundResource", C0004R.C0005drawable.notification_template_icon_bg);
                }
            }
            if (this.mBuilder.mLargeIcon != null) {
                if (Build.VERSION.SDK_INT >= 16) {
                    contentView.setViewVisibility(C0004R.C0006id.icon, 0);
                    contentView.setImageViewBitmap(C0004R.C0006id.icon, this.mBuilder.mLargeIcon);
                } else {
                    contentView.setViewVisibility(C0004R.C0006id.icon, 8);
                }
                if (showSmallIcon && this.mBuilder.mNotification.icon != 0) {
                    ...
                    if (Build.VERSION.SDK_INT >= 21) {
                        contentView.setImageViewBitmap(C0004R.C0006id.right_icon, createIconWithBackground(this.mBuilder.mNotification.icon, backgroundSize, iconSize, this.mBuilder.getColor()));
                    } else {
                        contentView.setImageViewBitmap(C0004R.C0006id.right_icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                    }
                    contentView.setViewVisibility(C0004R.C0006id.right_icon, 0);
                }
            } else if (showSmallIcon && this.mBuilder.mNotification.icon != 0) {
                contentView.setViewVisibility(C0004R.C0006id.icon, 0);
                if (Build.VERSION.SDK_INT >= 21) {
                    contentView.setImageViewBitmap(C0004R.C0006id.icon, createIconWithBackground(this.mBuilder.mNotification.icon, res.getDimensionPixelSize(C0004R.dimen.notification_large_icon_width) - res.getDimensionPixelSize(C0004R.dimen.notification_big_circle_margin), res.getDimensionPixelSize(C0004R.dimen.notification_small_icon_size_as_large), this.mBuilder.getColor()));
                } else {
                    contentView.setImageViewBitmap(C0004R.C0006id.icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                }
            }
            if (this.mBuilder.mContentTitle != null) {
                contentView.setTextViewText(C0004R.C0006id.title, this.mBuilder.mContentTitle);
            }
            if (this.mBuilder.mContentText != null) {
                contentView.setTextViewText(C0004R.C0006id.text, this.mBuilder.mContentText);
                showLine3 = true;
            }
            boolean hasRightSide = Build.VERSION.SDK_INT < 21 && this.mBuilder.mLargeIcon != null;
            if (this.mBuilder.mContentInfo != null) {
                contentView.setTextViewText(C0004R.C0006id.info, this.mBuilder.mContentInfo);
                contentView.setViewVisibility(C0004R.C0006id.info, 0);
                showLine3 = true;
                hasRightSide = true;
            } else if (this.mBuilder.mNumber > 0) {
                if (this.mBuilder.mNumber > res.getInteger(C0004R.integer.status_bar_notification_info_maxnum)) {
                    contentView.setTextViewText(C0004R.C0006id.info, res.getString(C0004R.string.status_bar_notification_info_overflow));
                } else {
                    contentView.setTextViewText(C0004R.C0006id.info, NumberFormat.getIntegerInstance().format((long) this.mBuilder.mNumber));
                }
                contentView.setViewVisibility(C0004R.C0006id.info, 0);
                showLine3 = true;
                hasRightSide = true;
            } else {
                contentView.setViewVisibility(C0004R.C0006id.info, 8);
            }
            if (this.mBuilder.mSubText != null && Build.VERSION.SDK_INT >= 16) {
                contentView.setTextViewText(C0004R.C0006id.text, this.mBuilder.mSubText);
                if (this.mBuilder.mContentText != null) {
                    contentView.setTextViewText(C0004R.C0006id.text2, this.mBuilder.mContentText);
                    contentView.setViewVisibility(C0004R.C0006id.text2, 0);
                    showLine2 = true;
                } else {
                    contentView.setViewVisibility(C0004R.C0006id.text2, 8);
                }
            }
            if (showLine2 && Build.VERSION.SDK_INT >= 16) {
                if (fitIn1U) {
                    contentView.setTextViewTextSize(C0004R.C0006id.text, 0, (float) res.getDimensionPixelSize(C0004R.dimen.notification_subtext_size));
                }
                contentView.setViewPadding(C0004R.C0006id.line1, 0, 0, 0, 0);
            }
            if (this.mBuilder.getWhenIfShowing() != 0) {
                if (!this.mBuilder.mUseChronometer || Build.VERSION.SDK_INT < 16) {
                    contentView.setViewVisibility(C0004R.C0006id.time, 0);
                    contentView.setLong(C0004R.C0006id.time, "setTime", this.mBuilder.getWhenIfShowing());
                } else {
                    contentView.setViewVisibility(C0004R.C0006id.chronometer, 0);
                    contentView.setLong(C0004R.C0006id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                    contentView.setBoolean(C0004R.C0006id.chronometer, "setStarted", true);
                }
                hasRightSide = true;
            }
            contentView.setViewVisibility(C0004R.C0006id.right_side, hasRightSide ? 0 : 8);
            contentView.setViewVisibility(C0004R.C0006id.line3, showLine3 ? 0 : 8);
            return contentView;
        }
        ...
        private Bitmap createIconWithBackground(int iconId, int size, int iconSize, int color) {
            int i = C0004R.C0005drawable.notification_icon_background;
            if (color == 0) {
                color = 0;
            }
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            ...
            if (showActions && this.mBuilder.mActions != null && (numActions = Math.min(this.mBuilder.mActions.size(), 3)) > 0) {
                ...
                for (int i = 0; i < numActions; i++) {
                    remoteViews.addView(C0004R.C0006id.actions, generateActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            if (!actionsVisible) {
                actionVisibility = 8;
    ...
    public static final class CarExtender implements Extender {
        ...
        private static UnreadConversation getUnreadConversationFromBundle(@Nullable Bundle b) {
            ...
            return new UnreadConversation(messages, remoteInput != null ? new RemoteInput(remoteInput.getResultKey(), remoteInput.getLabel(), remoteInput.getChoices(), remoteInput.getAllowFreeFormInput(), remoteInput.getExtras(), (Set<String>) null) : null, onReply, onRead, participants, b.getLong("timestamp"));
        }
